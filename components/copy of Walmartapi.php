            ...
            foreach ($ids as $id)
            {
                ...
                else
                {
                    ...
                    $imageArr1=explode(',',$image1);
                   	...
                   	if($merchant_id==226 || $merchant_id==294){
                ...
                foreach($product as $pro)
                {
                    ...
                    if ($pro['type'] == 'variants') 
                    {
                        ...
                        foreach ($varProducts as $value) 
                        {
                            ...
                            if(MERCHANT_ID==294){
                            	$update_price=$pro['comparision_price'];
                            }
                            else{
