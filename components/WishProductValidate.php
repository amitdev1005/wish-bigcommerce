...
use frontend\modules\wishmarketplace\controllers\FeedValidatorController;

class WishProductValidate extends Component
{
	...
	public static function validateProductXml($productData,$uploadType ="MPItem")
    {
        ...
        $productToUpload = [
            'MPItemFeed' => [
                '_attribute' => [
                    ...
                    'xsi:schemaLocation' => 'http://wish.com/ MPItem.xsd',
                ],
                '_value' => [
                    0 => [
                        'MPItemFeedHeader' => [
        ...
        $xsdPath = Yii::getAlias('@webroot').'/frontend/modules/wishmarketplace/components/Xml/wish_xsd/MPItemFeed.xsd';
    ...
    public static function validatev3ProductXml($productData)
    {
        ...
        $xsdPath = Yii::getAlias('@webroot').'/frontend/modules/wishmarketplace/components/Xml/v3item_xsd/MPItemFeed.xsd';
