...
*/
              ...
              $optiontitle=$title.'-'.$value['option_title'];
                ...
                // print_r($productArray);die("dfgdgf");
                $product = [
                
              //'parent_sku'=>$value['option_sku'],
                ...
                //print_r($product);
                 ...
                 $productUpload1[]=$product;
                 $productUpload=$productUpload1;
              ...
              // print_r($productUpload);
              
                $productUpload=$product;
                //print_r($productUpload);
                $productSku[]=$product['sku'];
                if($productUpload){
                    //print_r($productArray);die("ghdhdghhh");
