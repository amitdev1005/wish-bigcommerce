...
*/
                ...
                if($productUpload){
                    ...
                    if($response1['success']==1 && $response1['message']=="Successfully"){
                        
                    
                        $query="UPDATE `wish_product` SET status='Items Processing', error='' where product_id='".$productUpload['id']."'";
                        Data::sqlRecords($query,null,"update");
                        //print_r($query);die("gfhg");
                    }
