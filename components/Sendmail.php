...
class Sendmail extends Component
{
	...
	public static function uninstallmail($email)
	{
		...
		$headers_mer .= 'From: bigcommerce@cedcommerce.com' . chr(10);
		$headers_mer .= 'Bcc: stephenjones@cedcommerce.com' . chr(10);
		$headers_mer .= 'Bcc: barryallen@cedcommerce.com' . chr(10);
