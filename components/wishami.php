                      ...
                      if($response['success']==1){
                        ...
                        if($response['message']=="Successfully"){
                         ...
                         $updateresponse[]=$response['success'];
                                   // print_r($productUpload);die("gdfgd");
                ...
                foreach ($productVarArray as $value) 
                {
                  ...
                  //'parent_sku'=>$productArray['sku'],
                    ...
                    'product_status' => $value['status']
                     ...
                     $response=$this->CPostRequest(self::GET_FEEDS_ITEMS_ADD_SUB_URL,$product);
                     print_r($response);die("ghgfh");
                    if($response['success']==1){
                      $count++;
                    }
...
die("gfhghf");
                      ...
                      // $productUpload=$productvar;
                      // $productSku[]=$productvar['sku'];
                      // if($productUpload){

                      //   if($productvar['product_status'] !="Not Uploaded"){
                      //      $response=$this->CPutRequest(self::GET_ITEMS_UPDATE_SUB_URL,$productUpload);
                      //      print_r($response);die("dfggfdfgggdfg");
                      //   }
                      //   else{
                      //      $response=$this->CPostRequest(self::VARIANT_ADD_URL,$productUpload);
                      //      print_r($response);die("dsfgdgf");
                      //   }
