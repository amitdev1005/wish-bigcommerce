        ...
        <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content" id='edit-content'>
            <div class="modal-header">
              ...
              <h4 class="modal-title" style="text-align: center;font-family: "Comic Sans MS";">Order Current Status on Wish</h4>
            </div>
