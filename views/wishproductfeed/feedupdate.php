...
$ipmort_url=Yii::$app->request->baseUrl.'/wishmarketplace/wishproductfeed/index';

$url=\yii\helpers\Url::toRoute(['wishproductfeed/updatefeedstatus']);
$productfeedUrl= \yii\helpers\Url::toRoute(['wishproductfeed/index']);
