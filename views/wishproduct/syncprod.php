...
$ipmort_url = Yii::$app->request->baseUrl . '/wishmarketplace/wishproduct/index';

$url = \yii\helpers\Url::toRoute(['/wishmarketplace/wishproduct/shopifyproductsync']);
$productUrl = \yii\helpers\Url::toRoute(['/wishmarketplace/wishproduct/index']);
...
<div class="row">
    <div class="col-md-12 content-section" style="margin-top: 10px;">
        <div class="panel panel-default form new-section">
            <div class="jet-pages-heading">
                <div class="title-need-help">
                    <h1 class="Jet_Products_style">Sync store products</h1>
                </div>
            ...
            <div class="block-content panel-body shopify-api ">
                <ul class="warning-div" style="margin-top: 18px">
                    <li style="background-color:#Fff;">
                        ...
                        Starting Product Sync execution, please wait...
                    </li>
                    <li style="background-color:#FFD;">
                        <img
                            src="<?php echo yii::$app->request->baseUrl . '/frontend/images/batchupload/fam_bullet_error.gif'; ?>"
                            class="v-middle" style="margin-right:5px"/>
                        Warning: Please do not close the window during Sync data
                    </li>
                </ul>
                ...
                <ul id="profileRows">
                    ...
                    <li id="liFinished" style="display:none;background-color:#Fff;">
                        <img
                            src="<?php echo yii::$app->request->baseUrl . '/frontend/images/batchupload/note_msg_icon.gif'; ?>"
                            class="v-middle" style="margin-right:5px"/>
                        Finished product Sync execution.
                    </li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function uploaddata() {
        ...
        $.ajax({
            ...
            method: "post",
            dataType: 'json',
            data: {index: id + 1, _csrf: csrfToken, count: totalRecords},
...
//                    console.log(json.success);
                    ...
                    span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">' + json.success.count + ' products sync of page ' + id + '...</span>';
                    span.id = 'id-' + id;
