...
use yii\helpers\Html;
	...
	if($merchant_id==14){
		...
		$url=\yii\helpers\Url::toRoute(['walmartproduct/productretire']);
		...
		j$.ajax({
        	...
        	success: function(json) {//transport
				...
				if(json.success){
					...
					span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.success.count+'Products retired Successfully of page.'+id+'..</span>';
					span.id = 'id-'+id;
