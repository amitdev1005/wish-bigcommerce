...
use yii\helpers\Html;
	...
	$url=\yii\helpers\Url::toRoute(['wishproduct/bulkproductstatus']);
	...
	<div class="col-md-12" style="margin-top: 10px;">
		<div class="panel panel-default">
				<div class="jet-pages-heading">
					<h1 class="Jet_Products_style">Bulk Product Status</h1>
		...
		j$.ajax({
			...
			error: function(){
				...
				if(id < pages){
					...
					status_image.src = '<?php echo $succes_img ?>';
					var span = document.createElement('li');
					span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span id="update_status" class="text">'+countOfSuccess+' Product(s) Status .'+'</span>';
					span.style = 'background-color:#DDF';
					my_id.parentNode.insertBefore(span, my_id);
					//$('liFinished').show();
					j$(".warning-div").hide();
