...
use yii\helpers\Html;
	...
	$url=\yii\helpers\Url::toRoute(['wishproduct/start-batch-update']);
        ...
        <div class="panel panel-default form new-section">
            <div class="jet-pages-heading">
                    <div class="title-need-help">
                        <h1 class="Jet_Products_style">Bulk Product Syncing</h1>
                    </div>
		...
		j$.ajax({
        	...
        	success: function(json) {//transport
				...
				if(json.success) {
					...
					span.innerHTML = '<img class="v-middle" src="<?php echo $succes_img ?>"><span class="text">'+json.success.count+' products inventory of page '+id+'...</span>';
					span.id = 'id-'+id;
