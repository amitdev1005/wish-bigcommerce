...
$urlWalmart = \yii\helpers\Url::toRoute(['wishproduct/getwishdata']);
...
?>
    ...
    <div class="jet-product-index content-section ced-manageproduct">
        <div class="form new-section">
            <?= Html::beginForm(['wishproduct/ajax-bulk-upload'], 'post', ['id' => 'jet_bulk_product']);//Html::beginForm(['wishproduct/bulk'],'post');   ?>
            <div class="jet-pages-heading walmart-title">
                <div class="title-need-help">
                    <h1 class="Jet_Products_style"><?= Html::encode($this->title) ?></h1>
                    <a class="help_jet"
                       href="<?= Yii::$app->request->baseUrl ?>/wish-marketplace/sell-on-wish#sec5"
				...
				<div class="product-upload-menu m-menu confirmbox">
					...
					<!-- <?= Html::a('Get Promo Price Status', ['getpromostatus'], ['data-toggle' => 'tooltip', 'title' => 'Get product(s) promo price status from wish.', 'class' => 'btn btn-primary','data-confirm'=>'Click OK for Get Prome price status']) ?> -->
				...
				<div class="product-upload-menu confirmbox">
					...
					<div class="popup-box confirmbox">
						<button type="button" class="btn btn-primary noconfirmbox" id="sync_with_btn" data-step ='11' data-position = 'top' data-intro = 'Add New Product by entering the SKUs with comma seperators
' data-toggle='tooltip'
                            , title='Add New Product by entering the SKUs with comma seperators
' ,
                            onclick="addproduct()">Add Product
						</button>
                        <?/*
                        ...
                        */?>
						...
						<!-- <?= Html::a('Get Promo Price Status', ['getpromostatus'], ['data-toggle' => 'tooltip', 'title' => 'Get product(s) promo price status from wish.', 'data-step' => '12', 'data-position' => 'top', 'data-intro' => 'Get product(s) promo price status from wish.', 'class' => 'btn btn-primary','data-confirm'=>'Click OK for Update Promo Price Status']) ?> -->
                        <?/*
    ...
    <span class="font_bell">
      <i class="fa fa-list" aria-hidden="true"></i>
        ...
        $bulkActionSelect = Html::dropDownList('action', null, ['' => '-- select bulk action --', 'batch-upload' => 'Upload Product','start-batch-update' => 'Sync Selected Product(s)','batch-product-status' => 'Update Product Status', 'batch-retire' => 'Delete Product', /*'batch-update-price' => 'Update Price', 'batch-update-inventory' => 'Update Inventory'*/], ['id' => 'jet_product_select', 'class' => 'form-control', 'data-step' => '2', 'data-intro' => "Select the BULK ACTION you want to operate.", 'data-position' => 'bottom']);
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => ["Items Processing" => "Items Processing", "Not Uploaded" => "Not Uploaded", "PUBLISHED" => "PUBLISHED", "STAGE" => "STAGE", "UNPUBLISHED" => "UNPUBLISHED", "other" => "Other Products"],
                    'format' => 'html',
                    /*'value' => function ($data) {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    Click YES to Delete the Product else NO!!
                </div>
