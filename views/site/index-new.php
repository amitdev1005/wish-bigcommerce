...
$this->title = 'Bigcommerce Wish Integration - CedCommerce';
...
<div id="home-page">
    ...
    $this->registerCssFile(Yii::$app->request->baseUrl."/frontend/modules/wishmarketplace/assets/css/creative.css");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="<?php echo Yii::$app->request->baseUrl ?>/wishmarketplace/sell-on-wish" target="_blank">How to Sell on Wish?</a>
                        </li>
                    </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-2">
                        ...
                        <li>
                            <a class="page-scroll" href="<?php echo Yii::$app->request->baseUrl ?>/wish-marketplace/sell-on-wish" target="_blank">How to Sell on Wish?</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
    ...
    <header class="header-section">
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                src=<?= Yii::$app->request->getBaseUrl() . '/images/wish/wishogo.png' ?>>
                <hr>
                <p>All in one platform for merchants to list products on Wish marketplace and manage their inventory, order and shipping</p>
                <?php $form = ActiveForm::begin([
                    'id' => 'login-form',
                    'options' => ['class' => 'form-horizontal'],
                    'action' => \yii\helpers\Url::toRoute(['/wishmarketplace/site/login']),
                    'fieldConfig' => [
                    'template' => "{label}\n<div class=\"col-lg-12 shop-url-wrap\">{input}</div>",
                    ],
                    ]); ?>

                    <?= $form->field($model, 'username')->textInput(['placeholder'=>'example.mybigcommerce.com']) ?>
        ...
        <!--<meta content="Shopify Newegg Integration - CedCommerce" name="title">
        <meta content="Start Selling on Newegg.com - Choosing the ‘Appropriate Category’ might prove to be money spinning and could be an easy dig for the customers looking for your products." name="description">
        <meta content="shopify to newegg integration, newegg marketplace integration, newegg shopify integration app, newegg shopify integration" name="tags">
        <meta property="og:locale" content="en_US"/>

        <meta property="og:type" content="text/html; charset=utf-8"/>
        <meta property="og:title" content="Shopify Newegg Integration - CedCommerce"/>
        <meta property="og:description" content="Start Selling on Newegg.com - Choosing the ‘Appropriate Category’ might prove to be money spinning and could be an easy dig for the customers looking for your products."/>
        ...
        <meta property="og:image" content="https://shopify.cedcommerce.com/integration/frontend/modules/neweggmarketplace/assets/img/2bg_image1.png" />
        <meta name="twitter:card" content="summary"/>
        <meta name="twitter:title" content="Shopify Newegg Integration - CedCommerce"/>
        <meta name="twitter:description" content="Start Selling on Newegg.com - Choosing the ‘Appropriate Category’ might prove to be money spinning and could be an easy dig for the customers looking for your products."/>
        <meta name="twitter:site" content="@cedcommerce" />
        <link rel="canonical" href="https://shopify.cedcommerce.com/integration/neweggmarketplace/site/login" />-->
    </header>
                    ...
                    <div class="panels panels-shortcode">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Auto acknowledgement within 15 minutes of order placed on wish.com.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panels panels-shortcode">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Synchronized product information on wish with revised inventory.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panels panels-shortcode">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Easy listing and fulfilment with tracking information of wish orders from bigcommerce store.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panels panels-shortcode wow bounceIn">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Realtime error handling is achieved with our app. If issues occur in any product uploaded on wish.com, proper messages are shown in the notification section for errors.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panels panels-shortcode wow bounceIn">
                        <div class="panel-item margin-bottom-60">
                            ...
                            <div class="panels-text">
                                ...
                                Dashboard of our app gives the information about the total number of products uploaded on wish.com, number of live and archived products along with the number of orders imported by the app and your shops lifetime sales.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
                        ...
                        <hr>
                        <h6>Connect with wish</h6>
                        <p class="text-muted">Get notified automatically when any order is placed on wish for your products!</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">Earn regularly with your products sold on wish.com.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
                        ...
                        <hr>
                        <h6>Up to Date</h6>
                        <p class="text-muted">Remain updated every time something new happens to your products on wish.com.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-center">
                    <div class="service-box">
  ...
  <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="jet-plan-wrapper active Premium-plan" style="margin-left:430px">
              <h3 class="plan-heading">Premium</h3>
            <!--  <h3 class="plan-heading">Premium</h3> -->
        <div class="plan-wrapper">
          <span class="old-price"></span>
          <span class="price"><strong>$499</strong><span class="month"></span><br> Premium Plan</span>
        ...
        <a href="https://cedcommerce.com/bigcommerce-extensions/wish-bigcommerce-integration" target="_blank">
              ...
              <div class="what-can-do">
                  <ul>
                      ...
                      <li>Wish Category/Attributes Mapping</li>
            ...
            <!-- <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="jet-plan-wrapper active monthly plan">
                    ...
                    <div class="plan-wrapper">
                        <span style="padding: 0px;margin-top:3%;" class="price"><strong> $27</strong><span class="month">/month</span><br>(USD billed half-yearly)</span>
                        <h3 class="free"><span>FREE 15 Days</span></h3>
                        <div class="clear"></div>
                        <a href="http://cedcommerce.com/shopify-extensions/jet-shopify-integration"><div class="addtocart">Add to cart</div></a>
                    ...
                    <div class="what-can-do">
                        ...
                        <ul>
                            ...
                            <li>Mapping wish Category with Product Type</li>
                            <li>Inventory Synchronization</li>
                            <li>Order Management</li>
                            <li>Return Management</li>
                            <li>Settlement</li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <span>Ready to start your Bigcommerce-wish Integration with us? That's great! Give us a call or send us an email and we will get back to you as soon as possible!</span>
                    <hr class="primary">
                </div>
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:bigcommerce@cedcommerce.com">bigcommerce@cedcommerce.com</a></p>
                </div>
            </div>
        </div>
    </section>
