 ...
 */
class WishAttributeMap extends \yii\db\ActiveRecord
{
    const VALUE_TYPE_BIGCOM = 'map_with_bigcommerce_option';
    const VALUE_TYPE_WISH = 'predefined_wish_attribute_value';
