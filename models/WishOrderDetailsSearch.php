...
class WishOrderDetailsSearch extends WishOrderDetails
{
    ...
    public function rules()
    {
        return [
            ...
            [['order_total', 'sku', 'wish_order_id', 'order_data', 'shipment_data', 'status','created_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort'=> ['defaultOrder' => ['wish_order_id'=>SORT_DESC]]
        ]);
        ...
        $query->andFilterWhere(['like', 'sku', $this->sku])
            ...
            ->andFilterWhere(['like', 'wish_order_id', $this->wish_order_id])
